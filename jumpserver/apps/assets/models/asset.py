...
class Asset(OrgModelMixin):
    ...
    is_virtual = models.CharField(max_length=16, blank=True, null=True, verbose_name='是否是虚拟机')
    physical_machine = models.CharField(max_length=128, blank=True, null=True, verbose_name='宿主机标识')
