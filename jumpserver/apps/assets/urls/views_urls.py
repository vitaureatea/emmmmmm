...
urlpatterns = [
    ...
    path('network/',views.NetworkListView.as_view(),name="network-index"),
    path('network/nodelist/<str:nodename>/',views.networknodelist,name="network-node"),
    path('network/listcreate/',views.networkdrivecreate,name="network-create"),
    path('nodeview/nodeview/',views.nodeview,name="node-view"),
    path('nodeview/createnode/',views.createnode,name="node-create"),
    path('network/updatenetwork/<int:n_id>/',views.updatenetwork,name="network-update"),
    path('nodeview/updatenode/<str:n_id>/',views.updatenode,name="node-update"),
    path('network/networkdetail/<int:n_id>/',views.networkdetail,name="network-detail"),
    path('network/networkdel/<str:n_id>/',views.networkdel,name="network-del"),
    path('nodeview/nodedel/<int:n_id>/',views.nodedel,name="node-del"),
    path('network/user-network/',views.UserNetworkList.as_view(),name="user_network-index"),
    path('network/user-nodelist/<str:nodename>/',views.usernetworknodelist,name="user_network-node"),
