...
urlpatterns = [
    ...
    path('upfile-log/', views.UpfileLogListView.as_view(), name='upfile-log-list'),
    path('iis-log/', views.IisLogListView.as_view(), name='iis-log-list'),
    path('crontab-log/', views.CrontabLogListView.as_view(), name='crontab-log-list'),
]
